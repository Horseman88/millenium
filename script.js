...
const translations = {
  ...
  ru: {
    ...
    // Hero Section (index.html)
    heroTitle1: "SOLA",
    heroTitle2: "Бортовые системы искуственного интеллекта",
    heroDescription: "Цифровая интеллектуальная оптико-навигационная система стойкая к РЭБ, способна автоматически распозновать и доводить дрон к обьекту интереса.",
    ...
    // Falcon X1
    productFalconName: "SOLA Царица 10 дюймов",
    productFalconDescription: "Ударный дрон квадрокоптерного типа для автоматического завхата, распознования и доведения БПЛА к целе",
    productFalconSpecCamera: "до 2 кг полезной нагрузки",
    productFalconSpecFlight: "19 мин время полета",
    productFalconSpecRange: "20 км дальность",
    productFalconPrice: "$2,499",
    // Sparrow Z3
    productSparrowName: "SOLA Терн ",
    productSparrowDescription: "Ударно-разведывательный дрон самолетного типа, способен автоматически распозновать цели , а так же оснащен системой ручного захвата цели",
    productSparrowSpecCamera: "до 3 кг полезной нагрузки ",
    productSparrowSpecFlight: "60 мин время полета",
    productSparrowSpecRange: "70 км дальность",
    productSparrowPrice: "$3,899",
    // Eagle Pro
    productEagleName: "SOLA Тень",
    productEagleDescription: "Разведывательный квадрокоптер складного типа ",
    productEagleSpecImaging: "4к камера, 6х зум",
    productEagleSpecPrecision: "",
    ...
    featureExtendedRangeTitle: "Точность попадания",
    featureExtendedRangeDesc: "Наши дроны обладают системой автоматического полета к целе, что позволяет точно проводить операции вне зависимости от уровня оператора.",
    featureBatteryLifeTitle: "Оптимальная масса полезной нагрузки",
    featureBatteryLifeDesc: "Летайте дольше, возите больше. Благодаря использованию компактных систем обработки данных, масса полезной нагрузки такая же, как у обычных дронов без интелектуальной системы.",
    featureOpticsTitle: "Big data",
    featureOpticsDesc: "Датасет более 300 000 кадров, позволяет системе ИИ точно определять тип обьекта интереса.",
    // Call To Action (index.html)
